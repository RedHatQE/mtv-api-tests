...
def get_cluster_client() -> DynamicClient:
    ...
    verify_ssl = get_value_from_py_config(value="insecure_verify_skip")
    _client = get_client(host=host, username=username, password=password, verify_ssl=not verify_ssl)
