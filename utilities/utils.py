...
def gen_network_map_list(
    ...
    # Extract NAD name and namespace from dict
    multus_network_name_str = multus_network_name["name"]
    multus_namespace = multus_network_name["namespace"]

    if not multus_network_name_str:
        raise ValueError("multus_network_name['name'] cannot be empty - NAD base name is required")
