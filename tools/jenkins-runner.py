...
def main(
    ...
    if iib:
        iib_dict = get_mtv_latest_iib(version=mtv_version)[ocp_version]

        params["DEPLOY_MTV"] = True
        params["IIB_NO"] = iib_dict["IIB"]
        params["MTV_VERSION"] = mtv_version
...
if __name__ == "__main__":
    ...
    parser.add_argument("--deploy-ocp", help="Deploy the OCP cluster", action="store_true")
